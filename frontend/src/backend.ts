...
export class Backend implements backendInterface {
    ...
    async updateCallerSubscription(arg0: SubscriptionUpdate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCallerSubscription(to_candid_SubscriptionUpdate_n29(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_SubscriptionUpdate_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubscriptionUpdate): _SubscriptionUpdate {
...
function to_candid_record_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        status: to_candid_SubscriptionStatus_n31(_uploadFile, _downloadFile, value.status),
